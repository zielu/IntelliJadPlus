...
package net.stevechaloner.intellijad.config.jad;
...
public class JadConfigForm
{
     ...
     */
    public JadConfigForm(@Nullable final Project project)
    {
        this.project = project;

        navTriggeredDecomp.addItem(NavigationTriggeredDecompile.ALWAYS);
        navTriggeredDecomp.addItem(NavigationTriggeredDecompile.ON_DEMAND);
    ...
    private void setControlsEnabled(@Nullable Project project,
                                    boolean enabled)
    {
        Class<? extends JadConfigForm> thisClass = this.getClass();
